        ...
        <table class="table tableProductList tablePackageList">
            ...
            {foreach $products as $product}
                <tr{if $product.typ == 'danger'} class="danger"{/if}>
                    ...
                    {*                    <td>{if $product.typ == 'danger'}NIE{else}TAK{/if}</td>*}
                    ...
                    {*                    <td>{if $product.inShop == 1 && $product.typ == 'danger'}<span class="btn btn-success" disabled="disabled">Aktualizuj</span>{/if}</td>*}
