...
{*                <div class="form-group">*}
{*                    <label class="control-label col-lg-3 text-right">{l s='Status zamówienia z erli.pl: przygotowany' mod='pherli'}</label>*}
{*                    <div class="col-lg-2">*}
{*                        <select name="ERLI_STATUS_PREPARING">*}
{*                            <option value=""> {l s='- wybierz status -' mod='pherli'} </option>*}
{*                            {foreach $states as $state}*}
{*                                <option value="{$state.id_order_state}"{if $state.id_order_state == $status_1} selected="selected"{/if}> {$state.name} </option>*}
{*                            {/foreach}*}
{*                        </select>*}
{*                    </div>*}
{*                </div>*}
{*                <div class="form-group">*}
{*                    <label class="control-label col-lg-3 text-right">{l s='Status zamówienia z erli.pl: oczekuje na kuriera' mod='pherli'}</label>*}
{*                    <div class="col-lg-2">*}
{*                        <select name="ERLI_STATUS_WAITING">*}
{*                            <option value=""> {l s='- wybierz status -' mod='pherli'} </option>*}
{*                            {foreach $states as $state}*}
{*                                <option value="{$state.id_order_state}"{if $state.id_order_state == $status_2} selected="selected"{/if}> {$state.name} </option>*}
{*                            {/foreach}*}
{*                        </select>*}
{*                    </div>*}
{*                </div>*}
{*                <div class="form-group">*}
{*                    <label class="control-label col-lg-3 text-right">{l s='Status zamówienia z erli.pl: wysłany' mod='pherli'}</label>*}
{*                    <div class="col-lg-2">*}
{*                        <select name="ERLI_STATUS_SEND">*}
{*                            <option value=""> {l s='- wybierz status -' mod='pherli'} </option>*}
{*                            {foreach $states as $state}*}
{*                                <option value="{$state.id_order_state}"{if $state.id_order_state == $status_3} selected="selected"{/if}> {$state.name} </option>*}
{*                            {/foreach}*}
{*                        </select>*}
{*                    </div>*}
{*                </div>*}
