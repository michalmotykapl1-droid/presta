...
public $sources_content;
    public static $definition = array(
		...
		'faq_content' => array('type' => self::TYPE_HTML, 'lang' => true, 'validate' => 'isCleanHtml'),
'sources_content' => array('type' => self::TYPE_HTML, 'lang' => true, 'validate' => 'isCleanHtml'),
    ...
    'autoload_rte' => true,
    'tab' => 'basic',
    'form_group_class' => 'row_faq_content',
    'desc' => $this->l('FAQ section displayed at the end of the post. This content is also used to generate JSON-LD schema.')
),
'sources_content' => array(
    'type' => 'textarea',
    'label' => $this->l('Sources'),
    'lang' => true,
    'autoload_rte' => true,
    'tab' => 'basic',
    'form_group_class' => 'row_sources_content',
    'desc' => $this->l('Sources section displayed at the end of the post.')
),
    ...
    public static function getPostById($id_post, $id_lang = false)
    {
        ...
        $req = "SELECT p.*, pl.title, pl.meta_title, pl.meta_description, pl.meta_keywords, 
               pl.short_description, pl.description, pl.image, pl.thumb, pl.faq_content, pl.sources_content, 
    ...
    public function getCategories($id_lang = false, $enabled = false)
    {
        if(!$id_lang)    
            $id_lang = Context::getContext()->language->id;
        $req = "SELECT c.*, cl.* FROM `"._DB_PREFIX_."ets_blog_category` c
