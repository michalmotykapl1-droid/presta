...
>
  <div class="panel-body">
    ...
    <div class="form-wrapper">
      ...
      <div id="js-inpost-is-non-standard-wrapper">
        <div class="row">
          <div class="col">
            <div class="form-group">
              <label class="form-control-label">
              ...
              <div class="input-group">
                <span class="ps-switch">
                  <input type="radio"
                         ...
                         id="is_non_standard_off"
                         value="0"
                         {if !$isNonStandard}checked="checked"{/if}
                  >
                  <label for="is_non_standard_off">{l s='No' mod='inpostshipping'}</label>
                  <input type="radio"
                         name="is_non_standard"
                         id="is_non_standard_on"
                         value="1"
                         {if $isNonStandard}checked="checked"{/if}
                  >
                  <label for="is_non_standard_on">{l s='Yes' mod='inpostshipping'}</label>
                  <a class="slide-button btn"></a>
                </span>
              </div>
            </div>
