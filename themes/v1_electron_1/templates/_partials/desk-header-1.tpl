...
* @author PrestaShop SA <contact@prestashop.com>
 ...
 col-xl-4 col-sm-12 tvcms-header-logo-wrapper'>
 ...
 col-sm-12 tvcmsheader-nav-right">
 ...
 d="M15.666,17.321
        ...
        C1.764,23.134,8.041,17.321,15.666,17.321z"></path>
                                                <path style="fill:#FFD742;"
 d="M15.688,16.992c-4.494,0-8.15-3.654-8.15-8.148c0-4.497,3.656-8.152,8.15-8.152
 ...
 cx="15.689" cy="8.838" r="8.338"></circle>
                                            </g>
                                        </svg>
              
                                        {if $customer.is_logged }
                                            <span class="tvcms_customer_name">
                                                {* POPRAWKA V2: Sprawdzamy !empty dla $customer.gender.id, co jest bezpieczniejsze *}
                                                {if !empty($customer.gender.id) && isset($customer.gender.name[$customer.gender.id])}
                                    ...
                                    <ul class="dropdown-menu tv-account-dropdown tv-dropdown">
                                        ...
                                        <li classs="tvheader-compare ">{hook h='displayNavProductCompareBlock'}</li>
